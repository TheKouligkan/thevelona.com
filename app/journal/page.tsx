...
export default function JournalPage() {
  ...
  return (
    <main className="inner-main page-journal">
      ...
      <PageOutro eyebrow="See the story in motion" title="Follow the daily making on Instagram." copy="New pieces, workshop moments, colour studies and the people who wear VELONA." href="https://www.instagram.com/velona_crochet/" label="Visit Instagram" image="/velona/social-texture.jpg" imageAlt="VELONA crochet bag shared by the community" />
      <Footer />
    </main>
  );
}

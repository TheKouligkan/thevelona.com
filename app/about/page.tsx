...
export default function AboutPage() {
  return (
    <main className="inner-main page-about">
      ...
      <section className="drop-banner"><div className="drop-image"><Image src="/velona/brand-popup.jpg" alt="The VELONA handmade world at a community pop-up" fill sizes="(max-width: 760px) 100vw, 55vw" /></div><div className="drop-copy"><p className="eyebrow">The wider circle</p><h2>Learning,<br />making,<br /><em>sharing.</em></h2><p>VELONA also comes alive through workshops, pop-ups and the community around the craft. Handmade knowledge grows when it is passed on.</p></div></section>
